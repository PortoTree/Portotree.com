...
interface KesanggupanCanvasProps {
  formData: any;
  signatureData: string | null;
  pernyataanList: any[];
}

export function KesanggupanCanvas({ formData, signatureData, pernyataanList }: KesanggupanCanvasProps) {
    ...
    >
      <div className="flex flex-col flex-1">
        ...
        <div className="ml-1 mb-6 flex flex-col gap-1 cv-section break-inside-avoid">
          ...
          <div className="flex">
            <span className="w-[4cm] shrink-0">Pekerjaan</span>
            <span className="mr-2">:</span>
        ...
        <div className="text-justify mb-2 cv-section break-inside-avoid">
          Dengan ini menyatakan dengan penuh kesadaran dan tanpa paksaan dari pihak siapapun bahwa saya sanggup untuk:
        </div>
