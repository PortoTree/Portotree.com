      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 min-w-0 space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-slate-900 rounded-2xl p-6 text-white flex flex-col sm:flex-row items-center justify-between shadow-lg border border-slate-800">
            ...
            <a href="/p/resume/template" className="mt-4 sm:mt-0 whitespace-nowrap bg-white text-slate-900 font-bold py-3 px-6 rounded-xl hover:bg-slate-100 transition-colors shadow-md flex items-center gap-2">
              Lihat Template
